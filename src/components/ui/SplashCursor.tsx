...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function splatPointer(pointer: Pointer) {
      ...
      const color = pointer.color as { r: number; g: number; b: number };
    ...
    function generateColor() {
      const c = HSVtoRGB(Math.random(), 0.7, 0.8);
      c.r *= 0.06;
      c.g *= 0.06;
      c.b *= 0.06;
      return c;
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      if (!firstMouseMoveHandled) {
        ...
        updatePointerMoveData(pointer, posX, posY, pointer.color as { r: number; g: number; b: number });
      }
    }
